 ...
 */
package adf1javabasic.Bai52BaiTapOnLuyenLapTrinhOOP;
        ...
        do {
            ...
            switch (select) {
                ...
                case 4:
                    ...
                    for (int i = 0; i < ThuVien.size(); i++) {
                        if (ThuVien.get(i).getBookName().toLowerCase().contains(SearchBookName.toLowerCase())) {
                            System.out.println("Tên sách: " + ThuVien.get(i).getBookName());
                            SearchCount1++;
                        }
                ...
                case 5:
                    ...
                    System.out.println("Kết quả là: ");
                    for (int i = 0; i < ThuVien.size(); i++) {
                        if (ThuVien.get(i).getBookAuthor().toLowerCase().contains(SearchBookName.toLowerCase())) {
