 ...
 */
package adf1javabasic.Bai40BaiTapOnLuyenMenuChuongTrinh;
        ...
        do{
            ...
            switch (select) {
                case 1:
                    ...
                    break;
                case 2:
                    if((name.equalsIgnoreCase(""))&&(age==0)&&(address.equalsIgnoreCase(""))&&(email.equalsIgnoreCase(""))&&(phone.equalsIgnoreCase(""))){
